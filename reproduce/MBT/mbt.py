...
import timm
from vanillaencoder import VanillaEncoder, AdaptFormer
...
class AVmodel(nn.Module):
    def __init__(self, num_classes, num_latents, dim):
        ...
        ast_pretrained_weight = torch.load("/nas_data/WTY/cache/audioset_16_16_0.4422.pth") 
...
if __name__ == "__main__":
    model = AVmodel(num_classes=527, num_latents=8, dim=768)
    x = torch.randn(2, 128, 1006)
    y = torch.randn(2, 8, 3, 224, 224)
    logits = model(x, y)
    print(logits.shape)